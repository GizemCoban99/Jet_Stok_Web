...
!function (NioApp, $) {
  ...
  NioApp.SummerNote = function () {
    var _basic_tr = '.summernote-basic-tr';

      if ($(_basic_tr).exists()) {
          $(_basic_tr).each(function () {
        $(this).summernote({
      ...
      var _basic_en = '.summernote-basic-en';

      if ($(_basic_en).exists()) {
          $(_basic_en).each(function () {
              $(this).summernote({
                  placeholder: 'Hello stand alone ui',
                  tabsize: 2,
                  height: 500,
      ...
      var _basic_ru = '.summernote-basic-ru';

      if ($(_basic_ru).exists()) {
          $(_basic_ru).each(function () {
              $(this).summernote({
                  placeholder: 'Hello stand alone ui',
                  tabsize: 2,
                  height: 500,
