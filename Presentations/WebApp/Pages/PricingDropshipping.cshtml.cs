...
{
    public class PricingDropshippingModel : _BasePageModel
    {
        ...
        public PricingDropshippingModel(IMapper mapper, GenericValueService genericValueService) : base(mapper, genericValueService)
        {
        }
        ...
        public void OnGet()
        {
            ...
            packages.packages = _genericValueService.GetList(0, 10000, "", 35).Data;
            packages.packageFeature = _genericValueService.GetList(0, 10000, "", 38).Data;
