...
{
    public class PricingEcommerceModel : _BasePageModel
    {
        ...
        public PricingEcommerceModel(IMapper mapper, GenericValueService genericValueService) : base(mapper, genericValueService)
        {
        }
        ...
        public void OnGet()
        {
            ...
            packages.packageFeature = _genericValueService.GetList(0, 10000, "", 36).Data;
